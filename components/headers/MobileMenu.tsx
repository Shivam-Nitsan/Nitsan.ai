        ...
        <div className="mxd-menu__contain" ref={menuContainRef}>
          <div className="mxd-menu__inner">
            ...
            <div className="mxd-menu__left">
              ...
              >
                {
                  menu?.menuHeader?.upperHeader
                }
                <br />
                {
                  menu?.menuHeader?.lowerHeader
                }
              </p>
                            ...
                            >
                              {item.submenu.map((sub, i) => (
                                ...
                                >
                                  ...
                                  <p className="t-xsmall">{sub.description}</p>
                                </li>
                              ))}
                            </ul>
                          </>
              ...
              <div className="menu-promo">
                <div className="menu-promo__content">
                  <p
                    ...
                    style={{ transitionDelay: "0.4s" }}
                  >
                  {menu?.menuRightContent?.menuRightContentTop}
                    <br />
                  {menu?.menuRightContent?.menuRightContentBottom}
                  </p>
                  <div
            ...
            >
              <p className="t-xsmall">
                {menu?.menuFooter?.leftFooterStart} <i className="ph-fill ph-heart t-additional" /> {menu?.menuFooter?.leftFooterMiddle}{" "}
                <a
                  className="no-effect"
                  href="https://themeforest.net/user/ib-themes/portfolio"
                  target="_blank"
                >
                  {menu?.menuFooter?.leftFooterEnd}
                </a>
              </p>
              <p className="t-xsmall">
                <i className="ph ph-copyright" />
                 {menu?.menuFooter?.rightFooter}
              </p>
            </div>
          </div>
