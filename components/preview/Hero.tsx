...
export default function Hero() {
  ...
  const previewHero = data.preview?.previewHero || {};
  ...
  return (
      ...
      <div className="mxd-hero-00">
        <div className="mxd-hero-00__wrap">
          ...
          <div className="mxd-hero-00__top">
            { previewHero?.previewHeroTopGroup?.map((ele,index)=>(
               <div className="mxd-hero-00__title-wrap loading-wrap" key={index}>
              {/* title images */}
              ...
              <div className="mxd-hero-00__marquee loading__item">
                ...
                >
                  ...
                  {Array.from({ length: 5 }).map((_, index) => (
                    ...
                    >
                      <p>{ele["previewHeroTopGroup-marquee"]}</p>
                      <svg
                        version="1.1"
              ...
              <h1 className="hero-00-title">
                <span className="hero-00-title__row loading__item">
                  <em className="hero-00-title__item">{ele["previewHeroTopGroup-item1"]}</em>
                  <em className="hero-00-title__item title-item-transparent">
                   {ele["previewHeroTopGroup-marquee"]}
                  </em>
                </span>
                <span className="hero-00-title__row loading__item">
                  ...
                  <em className="hero-00-title__item">{ele["previewHeroTopGroup-item2"]}</em>
                </span>
              </h1>
            </div>
            ))}
          ...
          {/* bottom group */}
              {previewHero?.previewHeroBottomGroup?.map((ele,index)=>(
          <div className="mxd-hero-00__bottom" key={index}>
    ...
    {ele["previewHeroBottomGroup-text"]}
