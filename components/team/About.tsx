...
export default function About() {
  const section = data?.teamPage?.cultureSection;
  const testimonials = data?.teamPage?.testimonials;
              ...
              <div className="container-fluid p-0">
                <div className="row g-0">
                  {section.images.map((img, idx) => (
                    <div
                      key={idx}
                      className={`col-12 col-xl-6 mxd-values__item ${
                        idx % 2 === 1 ? "mobile-reverse" : ""
                      } mxd-grid-item no-margin animate-card-2`}
                    >
                      {img.parallax && (
                        <BackgroundParallax
                          className={`mxd-values__image ${img.className}`}
                        />
                      )}
                      {idx === 1 && (
          ...
          <div className="mxd-block">
            <VelocityMarquee className="marquee marquee-right--gsap muted-extra">
              <div className="marquee__toright">
                {Array.from({ length: section.marqueeCount }).map((_, i) => (
                  <div
                    key={i}
                    className="marquee__item one-line item-regular text"
                  >
                    <p className="marquee__text">{section.marqueeText}</p>
            ...
            <div className="testimonials-slider-2 no-padding">
              ...
              >
                {testimonials?.map((t, idx) => (
                  <SwiperSlide key={idx} className="swiper-slide mxd-fullwidth-slide no-blur">
                    <div className="mxd-testimonials-image">
                      <div className="row g-0 d-flex align-items-stretch fullheight-l">
                        <div className="col-12 col-xl-7 mxd-testimonials-image__content mxd-grid-item no-margin">
                          ...
                          >
                            <div className="mxd-testimonials-image__avatar">
                              <Image alt="Review Author" src={t.avatar} width={300} height={300} />
                            </div>
                            <div className="mxd-testimonials-image__info">
                              <h5 className="mxd-testimonials-image__name opposite">{t.author}</h5>
                        ...
                        <div
                          ...
                          data-swiper-parallax-opacity={0}
                        >
                          <Image alt="" src={t.illustration} width={1400} height={1400} />
                        </div>
                      </div>
                    </div>
                  </SwiperSlide>
                ...
                <div className="swiper-testimonials__controls">
                  <div className="swiper-button-prev mxd-slider-btn mxd-slider-btn-round-prev">
                    <a className="btn btn-round btn-round-small btn-outline opposite slide-left anim-no-delay" href="#">
                  ...
                  <div className="swiper-button-next mxd-slider-btn mxd-slider-btn-round-next">
                    <a className="btn btn-round btn-round-small btn-outline opposite slide-right anim-no-delay" href="#">
