          ...
          <div className="footer-blocks__card fullheight-card">
            ...
            <div className="footer-blocks__block">
              ...
              <div className="footer-blocks__title anim-uni-in-up">
                <p className="footer-blocks__title-l">{footer2?.menu1?.menuTitle}</p>
              </div>
              {/* footer socials */}
              <div className="footer-blocks__socials">
                <ul className="footer-socials">
                  {footer2?.menu1?.menus?.map((social, i) => (
        ...
        <div className="footer-blocks__column animate-card-3">
          ...
          <div className="footer-blocks__card fullheight-card">
            ...
            <div className="footer-blocks__block">
              {/* card title */}
              <div className="footer-blocks__title anim-uni-in-up">
                <p className="footer-blocks__title-l">{footer2?.menu2?.menuTitle}</p>
              </div>
              {/* footer socials */}
              <div className="footer-blocks__socials">
                <ul className="footer-socials">
                  {footer2?.menu2?.menus?.map((social, i) => (
                    <li key={i} className="footer-socials__item anim-uni-in-up">
                      <a
                        href={social.url}
                        className="footer-socials__link"
        ...
        <div className="footer-blocks__column animate-card-3">
          ...
          <div className="footer-blocks__card fullheight-card">
            ...
            <div className="footer-blocks__block">
              {/* card title */}
              <div className="footer-blocks__title anim-uni-in-up">
                <p className="footer-blocks__title-l">{footer2?.menu3?.menuTitle}</p>
              </div>
              {/* footer socials */}
              <div className="footer-blocks__socials">
                <ul className="footer-socials">
                  {footer2?.menu3?.menus?.map((social, i) => (
                    <li key={i} className="footer-socials__item anim-uni-in-up">
                      <a
                        href={social.url}
                        className="footer-socials__link"
            ...
            {/* links */}
            {footer2?.menu3?.menuInfo?.map((ele,index)=>(
               <div className="footer-blocks__links anim-uni-in-up" key={index} >
